...
// assets
import img_global_map from "@/assets/global_map.png";
import img_global_map_light from "@/assets/global_map_light.png";

import LoginForm from "@/components/auth/loginForm";
export default function Home() {
  return (
    <main className="h-[100dvh] relative">
      <div className="sm:flex sm:h-full w-full">
        <div className="overflow-hidden sm:w-[50%] sm:h-full">
          <div className="p-4 sm:p-8 flex flex-wrap gap-2 place-items-center">
            <Link href={"/"}>
              <svg
          ...
          <Image
            className="max-w-[140%]  ml-[-4rem] mt-[-5.3rem] sm:ml-[-10rem] sm:mt-[4rem] sm:max-w-[220%] hidden dark:block"
            src={img_global_map}
            alt=" "
            placeholder="blur"
            loading="lazy"
          />
          <Image
            className="max-w-[140%]  ml-[-4rem] mt-[-5.3rem] sm:ml-[-10rem] sm:mt-[4rem] sm:max-w-[220%]  dark:hidden"
